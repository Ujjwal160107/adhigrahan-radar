...
**Goal:** Make the backend serve the pipeline's real `vivaad.db` (schema per design doc §5b) so the DB drop-in actually works — closing the integration gap recorded in `docs/specs/2026-08-20-integration-handoff.md` items A1–A6.
